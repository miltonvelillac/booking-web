...
export function Header({ title }: HeaderProps) {
  ...
  return (
    <>
      <header className="sticky h-10 top-0 z-40 border-b border-black/10 dark:border-white/15 bg-background/80 backdrop-blur">
      ...
      {open && (
        <div className="fixed inset-0 z-50" role="dialog" aria-modal="true">
          ...
          <div
            id="mobile-menu"
            className="absolute left-0 top-0 h-full w-72 max-w-[85vw] bg-background border-r border-black/10 dark:border-white/15 shadow-xl p-4"
          >
            ...
            <nav className="mt-4">
              <ul className="space-y-1 text-sm">
                <li>
                  <a className="block rounded-md px-3 py-2 hover:bg-black/5 dark:hover:bg-white/10" href="#">
